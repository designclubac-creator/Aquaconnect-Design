...
import { downloadVCard, type ProfileData } from './lib/vCard';
...
export default function App() {
  ...
  const profile = {
    ...
    phone: "+91 99875 04339",
    whatsapp: "+91 99875 04339",
    email: "arpan@aquaconnect.blue",
    website: "aquaconnect.blue/global",
    linkedin: "https://www.linkedin.com/in/arpan-bhalerao/",
    qrImage: "https://api.qrserver.com/v1/create-qr-code/?size=220x220&data=https://arpanvcard.vercel.app/",
    bio: "Chief Growth Officer at Aquaconnect.",
  };
            ...
            >
              ...
              <div className="mt-10">
                <div className="flex items-center gap-3 rounded-2xl bg-slate-50 p-4 border border-slate-100">
                  <span className="flex-1 truncate text-xs font-medium text-slate-400">{window.location.host}/arpan_bhalerao</span>
                  <button 
                    onClick={() => {
